...
instance SVM_4 (C_SVM)
{
	...
	// -----------------------------------------------------------------------------------------------------------------------
	Smalltalk01					= "SVM_4_Smalltalk01"				;//...to rzeczywiście prawd...
...
instance SVM_6 (C_SVM)
{
	...
	UNTERSTADT_2_TEMPEL			= "SVM_6_UNTERSTADT_2_TEMPEL"		;//Idź od strony kuźni przez przejście, a dojdziesz do placu świątynnego.
	UNTERSTADT_2_HAFEN			= "SVM_6_UNTERSTADT_2_HAFEN"		;//Idź od strony kuźni w dół ulicą portową, a dojdziesz do portu.
	TEMPEL_2_UNTERSTADT			= "SVM_6_TEMPEL_2_UNTERSTADT"		;//Od placu świątynnego odchodzi przejście prowadzące do dolnej części miasta.
	TEMPEL_2_MARKT				= "SVM_6_TEMPEL_2_MARKT"			;//Kiedy będziesz przed świątynią, skręć w lewo i idź wzdłuż murów miejskich, a dojdziesz do targowiska.
	...
	MARKT_2_TEMPEL				= "SVM_6_MARKT_2_TEMPEL"			;//Jeżeli pójdziesz wzdłuż murów miejskich od strony targowiska, to dojdziesz do świątyni.
	MARKT_2_KASERNE				= "SVM_6_MARKT_2_KASERNE"			;//Koszary to ten wielki budynek. Dostaniesz się do nich po schodach naprzeciwko gospody.
	MARKT_2_GALGEN				= "SVM_6_MARKT_2_GALGEN"			;//Po prostu przejdź obok koszar, a dojdziesz do placu wisielców.
	GALGEN_2_TEMPEL				= "SVM_6_GALGEN_2_TEMPEL"			;//Idź od strony placu wisielców w dół uliczką, a dojdziesz do placu świątynnego.
	GALGEN_2_MARKT				= "SVM_6_GALGEN_2_MARKT"			;//Po prostu przejdź obok koszar, a dojdziesz do targowiska.
	GALGEN_2_KASERNE			= "SVM_6_GALGEN_2_KASERNE"			;//Koszary to ten wielki budynek. Dostaniesz się do niego po schodach.
	KASERNE_2_MARKT				= "SVM_6_KASERNE_2_MARKT"			;//Po prostu zejdź po schodach na lewo od głównego wejścia, a dojdziesz do targowiska.
	KASERNE_2_GALGEN			= "SVM_6_KASERNE_2_GALGEN"			;//Po prostu zejdź po schodach na prawo od głównego wejścia, a dojdziesz do placu wisielców.
	HAFEN_2_UNTERSTADT			= "SVM_6_HAFEN_2_UNTERSTADT"		;//Idź od strony muru przy nabrzeżu w górę ulicą portową, a dojdziesz do dolnej części miasta.
	// -------------------------------------------------------------------------------------
	...
	ADDON_WRONGARMOR			= "SVM_6_Addon_WrongArmor";				//To nie jest twoje ubranie. Nie będę z tobą rozmawiać.
	ADDON_WRONGARMOR_SLD		= "SVM_6_ADDON_WRONGARMOR_SLD";			//Jak ty wyglądasz? Ubierz się porządnie!
	ADDON_WRONGARMOR_MIL		= "SVM_6_ADDON_WRONGARMOR_MIL";			//Jesteś żołnierzem! Ubierz się odpowiednio!
	ADDON_WRONGARMOR_KDF		= "SVM_6_ADDON_WRONGARMOR_KDF";			//Twoje ubranie nie przynosi naszemu zakonowi chluby. Przebierz się!
	ADDON_NOARMOR_BDT			= "SVM_6_ADDON_ADDON_NOARMOR_BDT";		//Nie masz nawet pancerza. Zabieraj się stąd!

	ADDON_DIEBANDIT				= "SVM_6_ADDON_DIEBANDIT";				//Giń, bandycki pomiocie!
	ADDON_DIRTYPIRATE			= "SVM_6_ADDON_DIRTYPIRATE";			//Piracka świnia!
};
...
instance SVM_11 (C_SVM)
{
	...
	Smalltalk29					= "SVM_11_Smalltalk29"					;//...awsze działam w imieniu Innosa...
